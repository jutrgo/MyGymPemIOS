...
class EjercicioModel {
    ...
    private func crearEjercicios(){
        ...
        ejercicio = Ejercicio(nombreEjercicio: "Flexiones del brazo en el suelo", categoria: "Pectorales", descripcion: "En apoyo de cara al suelo, brazos estirados, manos separadas en una longitud igual a la anchura de los hombros (o más), pies juntos o muy poco separados: - Inspirar y flexionar los brazos para llevar la caja torácica cerca del sueo, siempre eviando curvar demasiado la region lumbar; - Empujar sobre el suelo hasta conseguir la extensión completa de los brazos; - Espirar al final del movimiento.")
        ejercicios.append(ejercicio) // añadir
        
        ejercicio = Ejercicio(nombreEjercicio: "Apertura con mancuernas", categoria: "Pectorales", descripcion: "Estirado sobre un banco estrecho para no molestar los movimientos de los hombros, mancuernas cogidas con las manos, brazos extendidos o codos ligeramente flexionados para aliviar la articulación: - Inspirar y después separar los brazos hasta la horizontal; - Elevar los brazos hasta la vertical expirando al mismo tiempo; - Provocar una pequeña contracción isométrica al final del movimiento para acentuar el trabajo sobre la parte esternal de los petorales.")
        ejercicios.append(ejercicio) // añadir
        
        
        
        ejercicio = Ejercicio(nombreEjercicio: "Tracción o dominadas en barra fija", categoria: "Espalda", descripcion: "En suspensión en la barra fija, manos muy separadas en pronación: - Inspirar y efecturar una tracción hasta que la nuca llegue casi a tocar la barra. Espirar al final del movimiento.")
        ejercicios.append(ejercicio) // añadir
